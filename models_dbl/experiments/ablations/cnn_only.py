"""Stage 2 CNN-only architecture ablation."""
...
def experiment_definition():
    return build_definition(
        EXPERIMENT_ID,
        factory="build_model",
        purpose="Measure performance without sequence modelling and Attention.",
